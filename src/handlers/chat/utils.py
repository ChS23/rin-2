...
def _sanitize_chat_text(text: str) -> str:
    ...
    # чужие алфавиты (CJK/кана/иврит/арабский/хангыль) — MiMo иногда роняет; Рин пишет кириллицей
    t = re.sub(r'[一-鿿぀-ヿ֐-׿؀-ۿ가-힯]', '', t)
    t = re.sub(r'  +', ' ', t)                                   # схлопнуть пробелы после вырезания
    return t.strip()
